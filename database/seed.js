...
async function seed() {
    ...
    const products = [
        ...
        { category_id: 5, name: "Шу Пуэр",         price: 560,  weight: 100, stock: 30, description: "Выдержанный шу пуэр с землистым вкусом и нотами тёмного шоколада.",                                 image_url: "images/puer.jpg" },
