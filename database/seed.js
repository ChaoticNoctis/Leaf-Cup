...
async function seed() {
    ...
    const products = [
        ...
        { category_id: 1, name: "Юньнань Дянь Хун",     price: 480,  weight: 100, stock: 40, description: "Элитный красный чай из провинции Юньнань. Медовый аромат, бархатистый вкус без терпкости.",       image_url: "images/black-tea.jpg" },
        { category_id: 1, name: "Ассам TGFOP",           price: 320,  weight: 100, stock: 50, description: "Крепкий индийский чай с солодовым вкусом. Идеален с молоком.",                                    image_url: "images/black-tea.jpg" },
        ...
        { category_id: 2, name: "Сенча Фукамуши",       price: 420,  weight: 100, stock: 35, description: "Японский зелёный чай глубокой пропарки. Насыщенный умами вкус, изумрудный настой.",                 image_url: "images/green-tea.jpg" },
        ...
        { category_id: 5, name: "Шэн Пуэр Бин Ча",     price: 980,  weight: 357, stock: 10, description: "Прессованный блин шэн пуэра 2019 года. Яркий, терпкий вкус с потенциалом выдержки.",                image_url: "images/puer.jpg" },
        { category_id: 6, name: "Матэ Традисьональ",    price: 390,  weight: 200, stock: 40, description: "Аргентинский матэ высшего сорта. Бодрящий травяной вкус с лёгкой горчинкой.",                       image_url: "images/mate.jpg" },
        ...
        { category_id: 8, name: "Набор «Чайный путь»",  price: 2490, weight: 300, stock: 12, description: "Набор из 5 сортов чая в стильной подарочной упаковке.",                                             image_url: "images/gifts.jpg" },
